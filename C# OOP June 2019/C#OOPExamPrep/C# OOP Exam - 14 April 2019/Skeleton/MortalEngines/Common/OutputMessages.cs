namespace MortalEngines.Common
{
    public class OutputMessages
    {
        ...
        public const string NameNullOrWhiteSpace = "Machine name cannot be null or empty.";

        public const string PilotCannotBeNull = "Pilot cannot be null.";

        public const string TargetCannotBeNull = "Target cannot be null";

        public const string PilotNameNullOrEmpty = "Pilot name cannot be null or empty string.";
